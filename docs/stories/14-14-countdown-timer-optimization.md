...
## Context
- Epic-12 retrospective flagged the countdown timer as re-creating its interval on every tick, which can be expensive when many timers are active (see `docs/sprint-artifacts/epic-12-retrospective.md` section "Countdown Timer Optimization").
