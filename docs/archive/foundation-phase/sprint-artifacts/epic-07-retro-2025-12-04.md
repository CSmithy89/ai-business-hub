...
|---|-------------|-------|----------|--------|
| 1 | Fix keyboard shortcut modifier key logic bug | Dev | Critical | ✅ Done |
| 2 | Add XSS sanitization for chat messages (DOMPurify) | Dev | Critical | ✅ Done |
| 3 | Optimize KeyboardShortcuts useEffect (use ref for showHelp) | Dev | Critical | ✅ Done |

### High Priority

| # | Action Item | Owner | Priority | Status |
|---|-------------|-------|----------|--------|
| 4 | Add Error Boundaries to dashboard layout sections | Dev | High | ✅ Done |
| 5 | Fix `as any` type assertion in SidebarNavItem | Dev | High | ✅ Done |
| 6 | Add React.memo to ChatMessage and optimize scroll effect | Dev | High | ✅ Done |
...
| # | Action Item | Owner | Priority | Status |
|---|-------------|-------|----------|--------|
| 8 | Create `useNullSafePathname()` hook | Dev | Medium | ✅ Done |
| 9 | Standardize timestamp handling utility | Dev | Medium | ✅ Done |
| 10 | Extract layout magic numbers to constants | Dev | Medium | ✅ Done |
| 11 | Add skip link for keyboard accessibility | Dev | Medium | ✅ Done |
| 12 | Fix responsive breakpoints for tablet (min-width issue) | Dev | Medium | ✅ Done |
...
| # | Action Item | Owner | Priority | Status |
|---|-------------|-------|----------|--------|
| 14 | Add ESLint rule for button type attributes | Dev | Low | ✅ Done |
| 15 | Document dynamic Tailwind limitation in CLAUDE.md | Dev | Low | ✅ Done |
| 16 | Create `usePlatform()` hook for Mac/Windows detection | Dev | Low | ✅ Done |
| 17 | Replace console.log with logger utility | Dev | Low | ✅ Done |
| 18 | Extract UI store key to constant | Dev | Low | ✅ Done |
