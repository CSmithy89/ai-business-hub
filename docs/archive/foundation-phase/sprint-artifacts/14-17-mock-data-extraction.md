...
- Epic 14 targets testing/observability; backlog item 14-17 from Epic 12 retro calls for moving mock data into a separate file for testability and maintenance. [Source: docs/archive/foundation-phase/sprint-artifacts/epic-12-retrospective.md]
...
- docs/archive/foundation-phase/sprint-artifacts/14-17-mock-data-extraction.context.xml
...
- docs/archive/foundation-phase/sprint-artifacts/14-17-mock-data-extraction.context.xml (context file)
- docs/archive/foundation-phase/sprint-artifacts/sprint-status.yaml (status updates)
- docs/archive/foundation-phase/sprint-artifacts/14-17-mock-data-extraction.md (status/tasks/notes)
