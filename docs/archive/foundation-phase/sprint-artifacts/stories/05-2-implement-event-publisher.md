...
- Tech Spec: `docs/archive/foundation-phase/sprint-artifacts/tech-spec-epic-05.md` (Section: Story 05.2)
...
- Story 05-1: `docs/archive/foundation-phase/sprint-artifacts/stories/05-1-set-up-redis-streams-infrastructure.md` (foundation)
