...
- Tech Spec: `docs/archive/foundation-phase/sprint-artifacts/tech-spec-epic-05.md` (Section: Story 05.4)
- Epic File: `docs/epics/EPIC-05-event-bus.md`
- Architecture: `docs/architecture.md` (Cross-Module Communication)
- Story 05-1: `docs/archive/foundation-phase/sprint-artifacts/stories/05-1-set-up-redis-streams-infrastructure.md`
- Story 05-2: `docs/archive/foundation-phase/sprint-artifacts/stories/05-2-implement-event-publisher.md`
- Story 05-3: `docs/archive/foundation-phase/sprint-artifacts/stories/05-3-implement-event-subscriber.md` (handleError placeholder)
