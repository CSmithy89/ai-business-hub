...
- Epic Technical Spec: `/docs/archive/foundation-phase/sprint-artifacts/tech-spec-epic-07.md`
- Story Context: `/docs/archive/foundation-phase/sprint-artifacts/stories/07-8-implement-keyboard-shortcuts.context.xml`
