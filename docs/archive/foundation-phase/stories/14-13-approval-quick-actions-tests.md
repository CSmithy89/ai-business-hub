...
## Context
- Learned from Epic-12 retro that quick actions are critical and tests were missing; Epic-14 tech debt adds unit coverage (see docs/archive/foundation-phase/sprint-artifacts/epic-12-retrospective.md).
