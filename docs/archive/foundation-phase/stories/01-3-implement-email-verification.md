...
1. `docs/archive/foundation-phase/sprint-artifacts/sprint-status.yaml`
...
_Tech spec reference: docs/archive/foundation-phase/sprint-artifacts/tech-spec-epic-01.md_
