...
- Tech Spec: `docs/archive/foundation-phase/sprint-artifacts/tech-spec-epic-14.md` (Section: Story 14.1)
- ADR-14.1: Vitest for Frontend Tests
- ADR-14.2: Testcontainers for Redis Integration Tests
- Epic 10 Retrospective: `docs/archive/foundation-phase/sprint-artifacts/retrospective-epic-10.md`
