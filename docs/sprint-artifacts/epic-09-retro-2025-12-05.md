...
|---|-------------|----------|-------|--------|
| 1 | Migrate rate limiting to Redis/Upstash | `rate-limit.ts`, `verify-login/route.ts` | Backend Dev | ❌ Pending |
| 2 | Complete or remove trusted device feature | `trusted-device.ts` | Backend Dev | ❌ Pending |
| 3 | Add encryption key entropy validation | Startup/config | Backend Dev | ❌ Pending |

### 🟡 Security (Address Soon)

| # | Action Item | Location | Owner | Status |
|---|-------------|----------|-------|--------|
| 4 | Improve XSS sanitization (DOMPurify) | `roles/route.ts` | Backend Dev | ❌ Pending |
| 5 | Fix backup code race condition | `verify-login/route.ts` | Backend Dev | ❌ Pending |
| 6 | Validate account unlinking safety | `unlink-account/route.ts` | Backend Dev | ❌ Pending |

### 🔵 Code Quality

| # | Action Item | Location | Owner | Status |
|---|-------------|----------|-------|--------|
| 7 | Consolidate duplicate rate limiters | Multiple files | Dev Team | ❌ Pending |
| 8 | Standardize error response format | All API routes | Dev Team | ❌ Pending |
| 9 | Extract magic numbers to constants | Multiple files | Dev Team | ❌ Pending |
| 10 | Fix `as any` type assertion | `unlink-account/route.ts` | Dev Team | ❌ Pending |
...
| 12 | Add BackupCode database indexes | Prisma schema | Backend Dev | ❌ Pending |
