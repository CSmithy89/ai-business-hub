      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Button asChild variant="outline" className="w-full">
            <a href="/api/auth/signin/microsoft" className="inline-flex items-center justify-center">
          ...
          <Button asChild variant="outline" className="w-full">
            <a href="/api/auth/signin/github" className="inline-flex items-center justify-center">
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
